"""
Show detailed JSON outputs from the model for various patient scenarios.
"""
import sys
import os
import json
...
scenarios = [
    {
        ...
        'data': {
            'visit_id': 7001, 'age': 34, 'bp_systolic': 140, 'bp_diastolic': 90,
    ...
    {
        'name': '❤️ Severe Chest Pain + Cardiac History',
        'data': {
            'visit_id': 7002, 'age': 65, 'bp_systolic': 180, 'bp_diastolic': 110,
    ...
    },
    {
        ...
        'data': {
            'visit_id': 7003, 'age': 62, 'bp_systolic': 165, 'bp_diastolic': 98,
    ...
    },
    {
        ...
        'data': {
            'visit_id': 7004, 'age': 25, 'bp_systolic': 120, 'bp_diastolic': 80,
...
print("\n" + "="*100)
print("MODEL JSON OUTPUTS - DETAILED VIEW")
print("="*100)
...
for scenario in scenarios:
    ...
    print(f"   Departments: {', '.join(prediction['recommended_departments'])}")
    print(f"   Primary: {prediction['primary_department']}")

print("\n" + "="*100)
print("✅ All JSON outputs shown above")
print("="*100)
